...
::: column-margin
You can find the code for the whole app on [github.com/londogard/lol_highlight_detection](https://github.com/londogard/lol_highlight_detection/).
:::

### Quick Backstory

My kid brother asked me to help him earn some quick bucks through automating a process to build highlight-videos of E-Sports to upload on YouTube. The emphasis was on a single streamer, [TheBausFFS](https://www.twitch.tv/thebausffs/)[^1].

[^1]: TheBausFFS is a famous Swedish streamer in League of Legends (LoL). He's focusing on being fun and speaking as much "swenglish" (svengelska) as possible.

When I set out my brother had hope to earn cash and I to learn new tools and assist my family with my deep knowledge. 💪
...
Following from here I'll share some building blocks to create an exciting *Data App*. To learn more about Solara basics I refer to my [previous blog](../2023-06-30-solara), \@ where I compare it with Streamlit and introduce how to build a simple solara app. I'll share code snippets and videos of the app. The resulting code covers most of the building blocks required to build everything from basic to complex Data Apps!
...
> `solara.Result[T]` has two important values. `state` which is one of the following: `[..., RUNNING, FINISHED]`. Once finished `value` will be filled of the result `T`.
